...
<link href="styleaa.css" rel="stylesheet" type="text/css">
...
/*	else if(document.frm.college.value == ""){
		alert("Please Select the College/Unit Name");
		return false
	}
*/	
...
<table width="1100" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tbody><tr>
    ...
    <td><link href="./risku_files/styleaa.css" rel="stylesheet" type="text/css">
<table width="1100" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td bgcolor="#FFFFFF"><table width="80%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#999999">
      <form method="post" action="addu.php" name="frm">
	  	  <tbody><tr>
	    <td height="28" bgcolor="#F2F2F2" class="blue">Select Your Department </td>
	    <td bgcolor="#FFFFFF" class="s-orange"><input name="department" type="radio" value="Co" onclick="location.href='college.php'">
	      College 
	        &nbsp;&nbsp;
	        <input name="department" type="radio" value="Un" onclick="location.href='unit.php'" checked="">
Unit </td>
	    </tr>
	  <tr id="tr_college">
        <td width="28%" height="28" bgcolor="#F2F2F2" class="blue">Select College/Unit:</td>
        <td width="72%" bgcolor="#FFFFFF"><select name="college" class="txt" id="college" >
        <option value="">- Select College/Unit -</option>
				<option value="CSI">Statiscits</option>
				<option value="QAC">Quality</option>
				</select>        </td>
	  </tr>
	  	  <tr>
